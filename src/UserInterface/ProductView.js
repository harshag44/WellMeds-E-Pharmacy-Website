            ...
            return (
                <div>
                    <div className={classes.imagediv} >
                        <div style={{ padding: 5 }}>
                            <img onClick={() => handleChangePicture(item.image)} src={`${ServerURL}/images/${item.image}`} style={{ width: '100%', height: 70, cursor: 'pointer' }} alt=""/>
                        </div>
                    </div>
                </div> 
                ...
                <Grid container spacing={2} >
                    <Grid item xs={6} style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column' }} >
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
                            ...
                            <img src={`${ServerURL}/images/${image}`} style={{height: 200, padding:20 }} alt=""/>
                        </div>
                    ...
                    <Grid item xs={6}>
                        <Grid style={{ fontSize: 24, fontWeight: 'normal', fontFamily: 'Sarabun', marginBottom: 30 }}>
                            ...
                            <div style={{ fontSize: 16, fontFamily: 'Poppins', marginTop: 5 }}> {product.description}</div>
                        </Grid >
                        <Divider />
                        ...
                        <Grid style={{ fontSize: 16, fontFamily: 'Sarabun' }}>
                            ...
                            <div style={{marginTop:10}}>* Marketed By: Inlife Pharma Private Limited</div>
